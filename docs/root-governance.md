# Root Governance: MongoDB-Knowledge-Base

Dokumen ini memuat aturan tingkat root untuk monorepo **MongoDB Knowledge Base**.
...
- `.cursorrules`: Sebagai hukum interaksi AI khusus MongoDB.
...
- Konvensi penomoran & AI Persona (NoSQL Document Database Architect).
